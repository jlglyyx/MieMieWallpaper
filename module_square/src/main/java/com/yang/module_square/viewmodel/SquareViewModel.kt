...
//        MobSDK.submitPolicyGrantResult(checkStatus)
    ...
    fun getTabs(){
        launch({
            squareRepository.getTabs(wallType)
        },{
    ...
    fun getWallpaper(tabId:String?,keyword:String = "",isCollection:Boolean = false){
        launch({
            ...
            squareRepository.getWallpaper(params)
        },{
...
//        launch({
//            squareRepository.getUserInfo(id)
//        },{
//
//
//        },{
...
//            params[AppConstant.Constant.PAGE_NUMBER] = pageNum
//            params[AppConstant.Constant.PAGE_SIZE] = AppConstant.Constant.PAGE_SIZE_COUNT
//            squareRepository.getTaskList(params)
//        },{
//
//
//        },{
...
//        launch({
//            squareRepository.insertTask(taskData)
//        }, {
...
//            }
//            squareRepository.uploadFile(mutableMapOf)
//        }, {
...
//            }
//
//            squareRepository.uploadFileAndParam(mutableListOf)
//        }, {
//            pictureListLiveData.postValue(it.data)
//        }, messages = *arrayOf(getString(R.string.string_uploading), getString(R.string.string_insert_success)))
//    }
